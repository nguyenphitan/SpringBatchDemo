package com.nguyenphitan.SpringBatch.config;
...
import com.nguyenphitan.SpringBatch.entity.Order;
import com.nguyenphitan.SpringBatch.notification.JobCompletionNotificationListener;
import com.nguyenphitan.SpringBatch.repository.OrderRepository;
...
public class BatchConfiguration {
	...
	public ItemReader<Order> reader() {
		return new FlatFileItemReaderBuilder<Order>()
			...
			.delimited()
			.names(new String[] {"id", "customerId", "itemId", "itemName", "itemPrice"})
